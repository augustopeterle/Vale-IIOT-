...
// GILL Instruments Sensors string
#define SENSOR_GMX_WD 172 //Wind Relative Direction
#define SENSOR_GMX_WS 173 //Wind Speed
#define SENSOR_GMX_TA 174 // Temperature of Air
#define SENSOR_GMX_RH 175 // Relative Humidity
#define SENSOR_GMX_DP 176 // Dewpoint
#define SENSOR_GMX_PA 177 // Pressure of Air
#define SENSOR_GMX_TP 178 // Total Precipitation
#define SENSOR_GMX_IP 179 // Precipitation intensity
#define SENSOR_GMX_GHI 180 // Global Hemispheric Irradiation
#define SENSOR_GMX_BAT 181 // Global Hemispheric Irradiation
...
// GILL Instruments sensors
const char str_GMX_WD[] PROGMEM = "GMX_WD"; // 172
const char str_GMX_WS[] PROGMEM = "GMX_WS"; // 173
const char str_GMX_TA[] PROGMEM = "GMX_TA"; // 174
const char str_GMX_RH[] PROGMEM = "GMX_RH"; // 175
const char str_GMX_DP[] PROGMEM = "GMX_DP"; // 176
const char str_GMX_PA[] PROGMEM = "GMX_PA"; // 177
const char str_GMX_TP[] PROGMEM = "GMX_TP"; // 178
const char str_GMX_IP[] PROGMEM = "GMX_IP"; // 179
const char str_GMX_GHI[] PROGMEM = "GMX_GHI";// 180
const char str_GMX_BAT[] PROGMEM = "GMX_BAT";// 181
